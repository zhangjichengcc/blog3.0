...
const questionSchama: questionSchamaProps[] = [
  // key: radio_*
  {icon: danxuanSvg, label: '单选题', key: 'radio_', schema: {
    "title": "单选题",
    "type": "string",
    "required": true,
    "enum": [
  ...
  {icon: duoxuanSvg, label: '多选题', key: 'checkboxes_', schema: {
    "title": "多选题",
    // "description": "点击多选",
    "required": true,
    "type": "array",
  ...
  {icon: xialaSvg, label: '下拉题', key: 'select_', schema: {
    "title": "下拉题",
    "required": true,
    "type": "string",
    "enum": [
  ...
  {icon: danhangSvg, label: '单行文本', key: 'input_', schema: {
    "title": "单行文本",
    "required": true,
    "type": "string",
    'ui:widget': 'edit-string'
  }},
  {icon: duohangSvg, label: '多行文本', key: 'textarea_', schema: {
    "title": "多行文本",
    "required": true,
    "type": "string",
    "format": "textarea"
  ...
  //   "title": "附件题",
  // }},
  {icon: liangbiaoSvg, label: '量表题', key: 'gauge_', schema: {
    "title": "量表题",
    "required": true,
    "enum": ["1","2","3","4","5"],
    "degree": ["起始值","结束值"],
  ...
  {icon: jzdxSvg, label: '矩阵单选题', key: 'matrixRadio_', schema: {
		"properties": {
			"questions": {
				"enum": ["1","2","3"],
  ...
  {icon: jzdxsSvg, label: '矩阵多选题', key: 'matrixCheckboxes_', schema: {
		"properties": {
			"questions": {
				"enum": ["1","2","3"],
				"enumNames": ["问题1","问题2","问题3"],
  ...
  {icon: jzlbSvg, label: '矩阵量表题', key: 'heckboxesGauge_', schema: {
		"properties": {
			"questions": {
				"enum": ["1","2","3"],
				"enumNames": ["问题1","问题2","问题3"],
