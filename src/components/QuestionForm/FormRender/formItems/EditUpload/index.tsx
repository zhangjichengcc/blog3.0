...
const EditString: FC<editStringProps> = ({
  ...
  // 题目编辑
  function onEditFormChange(e: React.ChangeEvent<HTMLInputElement>, key: string) {
    setEdittForm({
      ...editForm,
      [key]: e.target.value,
    })
          ...
          { edit ?
            ...
            <div className={styles.editForm}>
              <Form labelCol={{xs: {span: 24}, sm: {span: 4}}} wrapperCol={{xs: {span: 24}, sm: {span: 20}}}>
                ...
                >
                  <Input placeholder="请输入题目" value={editForm.title} onChange={e => onEditFormChange(e, 'title')} />
                </Form.Item>
                <Form.Item label="是否必填">
                  <Radio.Group defaultValue={1} value={editForm.required ? 1 : 0} onChange={onRequiredChange}>
              ...
              <div className={styles.questionArea}>
                ...
                <div className={styles.questionBody}>
                  <Dragger>
                    ...
                    <p className="ant-upload-text">点击添加文件或将文件拖拽到此处</p>
                  </Dragger>
                </div>
              </div>
